...
<div class="max-w-[95%] flex justify-between items-enter mx-auto mt-6 mb-4 font-cairo">
  <input type="search" name="search-service" id="" class="rounded-md w-80 py-3 px-10 outline-none border-transparent focus:border-transparent focus:ring-0 " placeholder="ابحث">
  <div>

    <a href="{{ route('dashboard.service.create') }}" class="px-10 py-2 text-white bg-blue-500 rounded-md">أضف عرضا أخر</a>
    <a href="{{ route('service.soft_delete') }}" class="bg-blue-500  text-white font-bold py-2 px-4 rounded">
        ...
        <tr class="hover:bg-gray-50">
          <th class="flex gap-3 px-6 py-4 font-normal text-gray-900">
            ...
            <div dir="rtl" class="text-sm">
              ...
              <div class="text-xs text-gray-400">{{ $service->platform }}</div>
            ...
            <td class="px-6 py-4">
                <a href="{{ route('service.details', $service->id) }}" target="_blank"
            ...
            <td class="px-6 py-4">
                ...
                <a x-data="{ tooltip: 'Edite' }" href="{{ route('dashboard.service.edit', $service) }}">
                    <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
