...
<form dir="rtl" action="{{ route('dashboard.advertisement.store') }}" method="POST" class="max-w-[90%] mx-auto my-8 bg-white rounded-2xl p-8 font-cairo"  enctype="multipart/form-data">
    ...
    <div class="mb-6">
      ...
      <input type="text" id="title" name="title" value="{{ old('title') }}"  class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 outline-none focus:ring-0" placeholder="(حساب لفل 55 يحتوي (12 شخصيه" required />
    </div>
    ...
    <div class="mb-6">
      ...
      <input type="number" min="00" id="account_level" name="account_level"  value="{{ old('account_level') }}"  class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 outline-none focus:ring-0" placeholder="59" required />
    </div>

    <div class="mb-6">
      <label for="user_email" class="block mb-3 text-sm font-medium text-gray-500 ">اميل صاحب الحساب</label>
      <input type="email" min="0" id="user_email" name="user_email" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 outline-none focus:ring-0" placeholder="user@gmail.com" required />
    </div>
    ...
    <div class="mb-6">
        ...
        <input type="file" id="advertisement_picture" name="picture" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 outline-none  focus:border-transparent focus:ring-0" placeholder="120" required />
    </div> 
