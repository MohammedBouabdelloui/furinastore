...
<div class="max-w-[95%] flex justify-between items-enter mx-auto mt-6 mb-4 font-cairo">
  ...
  <div>
    ...
    <a href="{{ route('dashboard.advertisement.create') }}" class="px-10 py-2 text-white bg-blue-500 rounded-md">أضف عرضا أخر</a>
      {{-- <a href="{{ route('advertisement.soft_delete') }}" class="bg-blue-500  text-white font-bold py-2 px-4 rounded">
        ...
        <tr class="hover:bg-gray-50">
          <th class="flex gap-3 px-6 py-4 font-normal text-gray-900">
            ...
            <div dir="rtl" class="text-sm">
              ...
              <div class="text-gray-400">{{ $advertisement->topup_value }} </div>
            </div>
          </th>
            ...
            <td class="px-6 py-4">
                <div class="flex justify-end gap-4">
                  {{-- <form action="{{ route('advertisement.soft-delete', $advertisement->id) }}" method="POST">
                    @csrf
                    @method('DELETE')
                ...
                <a x-data="{ tooltip: 'Edite' }" href="{{ route('dashboard.advertisement.edit', $advertisement) }}">
                    <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
