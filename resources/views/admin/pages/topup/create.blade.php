    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
      ...
      <li>
        <div class="flex items-center">
          ...
          <a href="{{ route('dashboard.topup.create') }}" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-blue-700">Add</a>
        </div>
      </li>
    </ol>
</nav>
...
<form dir="rtl" action="{{ route('dashboard.topup.store') }}" method="POST" class="max-w-[90%] mx-auto my-8 bg-white rounded-2xl p-8 font-cairo" enctype="multipart/form-data">

    @csrf

    <h1 class="text-3xl font-bold text-gray-900 mb-6">أضف منتوجا من نوع عمليات الشحن</h1>

    <div class="mb-6">
      <label for="title" class="block mb-3 text-sm font-medium text-gray-500 ">عنوان المنتوج</label>
      <input type="text" id="title" name="title" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 outline-none  focus:border-transparent focus:ring-0" placeholder="8080 كرستالة" required />
    </div>
    ...
    <div class="mb-6">
      ...
      <input type="text" 
       ...
       id="price" 
       name="price" 
       class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 outline-none focus:border-transparent focus:ring-0" 
       placeholder="800 د.م" 
       required 
       pattern="[0-9]+(\.[0-9]+)?" 
    ...
    <div class="mb-6">
      <label for="topup_value" class="block mb-3 text-sm font-medium text-gray-500 ">القيمة المطلوبة</label>
      <input type="number" min="0" id="topup_value" name="topup_value" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 outline-none  focus:border-transparent focus:ring-0" placeholder="120" required />
    </div>
    ...
    <div class="mb-6">
        <label for="topup_picture" class="block mb-3 text-sm font-medium text-gray-500 ">صورة المنتوج</label>
        <input type="file" id="topup_picture" name="picture" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 outline-none  focus:border-transparent focus:ring-0" placeholder="120" required />
    </div> 
    ...
    return {
        ...
        init: function(el) {
            ...
            *, ::after, ::before {box-sizing: border-box;}
            ...
            <h1>شرح المنتوج</h1>
            `;
            document.getElementById('description').value = this.wysiwyg.contentDocument.body.innerHTML;
