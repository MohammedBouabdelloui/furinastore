...
<form dir="rtl" action="{{ route('dashboard.topup.store') }}" method="POST" class="max-w-[90%] mx-auto my-8 bg-white rounded-2xl p-8 font-cairo" enctype="multipart/form-data">
    ...
    <div class="mb-6">
      ...
      <input type="number" min="0" id="topup_value" name="topup_value" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 outline-none focus:ring-0" placeholder="120" required />
    </div>
