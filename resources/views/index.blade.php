...
@section('content')
    ...
    <div  class="mx-auto xl:max-w-[1280px] font-cairo mt-12 my-4">
        ...
        <div dir="rtl" class="my-4 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-2 gap-y-6 lg:gap-x-4 lg:gap-y-12 mx-2">
            ...
            <div class="bg-slate-50 rounded-md ">
                ...
                <div class="flex flex-col justify-center items-center">
                    <a href="{{ route('topup.details' , $topup->id) }}">
                        ...
                        <div class="flex justify-center items-center mt-1">
                            <span class="mx-1 text-xs lg:text-sm">(تم الشراء {{ $topup->productOrder->count() }})</span>                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" style="fill: rgb(255, 242, 0);transform: ;msFilter:;"><path d="M21.947 9.179a1.001 1.001 0 0 0-.868-.676l-5.701-.453-2.467-5.461a.998.998 0 0 0-1.822-.001L8.622 8.05l-5.701.453a1 1 0 0 0-.619 1.713l4.213 4.107-1.49 6.452a1 1 0 0 0 1.53 1.057L12 18.202l5.445 3.63a1.001 1.001 0 0 0 1.517-1.106l-1.829-6.4 4.536-4.082c.297-.268.406-.686.278-1.065z"></path></svg>
                        ...
                        <button dir="rtl" class="my-2 text-center  font-bold text-md w-full bg-slate-200 py-2 rounded-md hover:bg-slate-300 transition ease-in-out duration-300">{{ $topup->price }}  د.م </button>
    ...
    <div class="mx-auto xl:max-w-[1280px] font-cairo mt-12 my-4">
        ...
        <div dir="rtl" class="my-4 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-2 gap-y-6 lg:gap-x-4 lg:gap-y-12 mx-2">
            ...
            <div class="bg-slate-50 rounded-md ">
                ...
                <div class="flex flex-col justify-center items-center">
                    ...
                    <img src="{{ asset('storage/' . $reroll->picture) }}" alt="" class="w-full h-[240px] lg:h-[260px] object-cover rounded-xl">

                    <h1 class="font-bold text-lg my-2">{{ $reroll->title }}</h1>

                    <div class="flex justify-center items-center mt-1">
                        <span class="mx-1 text-xs lg:text-sm">({{ $reroll->number_sales }})</span>
                    ...
                    <button dir="rtl" class="my-2 font-bold text-md w-[95%] bg-slate-100 py-2 rounded-md">{{ $reroll->price }}</button>
        ...
        <div class="flex justify-center items-center">
            ...
            <a href="{{ route('reroll') }}" class="mx-auto text-center text-lg py-1 px-10 border border-blue-600 text-blue-600 hover:text-white hover:bg-blue-600 rounded-sm transition ease-in-out duration-500">أظهر المزيد</a>
    ...
    <div class="mx-auto xl:max-w-[1280px] font-cairo mt-12 my-4">
        ...
        <div dir="rtl" class="my-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-2 gap-y-2 mx-2" dir="rtl">
    ...
    <div class="mx-auto xl:max-w-[1280px] font-cairo mt-12 my-4">
        ...
        <div dir="rtl" class="my-4 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-2 gap-y-6 lg:gap-x-4 lg:gap-y-12 mx-2">
            ...
            @foreach ($services as $service)
                ...
                <a href="{{ route('service.details', $service->id) }}" class="bg-slate-50 rounded-md ">
                    ...
                    <div class="flex flex-col justify-center items-center">
                        ...
                        <div class="flex justify-center items-center mt-1">
                            <span class="mx-1 text-xs lg:text-sm">({{ $service->number_sales }})</span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" style="fill: rgb(255, 242, 0);transform: ;msFilter:;"><path d="M21.947 9.179a1.001 1.001 0 0 0-.868-.676l-5.701-.453-2.467-5.461a.998.998 0 0 0-1.822-.001L8.622 8.05l-5.701.453a1 1 0 0 0-.619 1.713l4.213 4.107-1.49 6.452a1 1 0 0 0 1.53 1.057L12 18.202l5.445 3.63a1.001 1.001 0 0 0 1.517-1.106l-1.829-6.4 4.536-4.082c.297-.268.406-.686.278-1.065z"></path></svg>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" style="fill: rgb(255, 242, 0);transform: ;msFilter:;"><path d="M21.947 9.179a1.001 1.001 0 0 0-.868-.676l-5.701-.453-2.467-5.461a.998.998 0 0 0-1.822-.001L8.622 8.05l-5.701.453a1 1 0 0 0-.619 1.713l4.213 4.107-1.49 6.452a1 1 0 0 0 1.53 1.057L12 18.202l5.445 3.63a1.001 1.001 0 0 0 1.517-1.106l-1.829-6.4 4.536-4.082c.297-.268.406-.686.278-1.065z"></path></svg>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" style="fill: rgb(255, 242, 0);transform: ;msFilter:;"><path d="M21.947 9.179a1.001 1.001 0 0 0-.868-.676l-5.701-.453-2.467-5.461a.998.998 0 0 0-1.822-.001L8.622 8.05l-5.701.453a1 1 0 0 0-.619 1.713l4.213 4.107-1.49 6.452a1 1 0 0 0 1.53 1.057L12 18.202l5.445 3.63a1.001 1.001 0 0 0 1.517-1.106l-1.829-6.4 4.536-4.082c.297-.268.406-.686.278-1.065z"></path></svg>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" style="fill: rgb(255, 242, 0);transform: ;msFilter:;"><path d="M21.947 9.179a1.001 1.001 0 0 0-.868-.676l-5.701-.453-2.467-5.461a.998.998 0 0 0-1.822-.001L8.622 8.05l-5.701.453a1 1 0 0 0-.619 1.713l4.213 4.107-1.49 6.452a1 1 0 0 0 1.53 1.057L12 18.202l5.445 3.63a1.001 1.001 0 0 0 1.517-1.106l-1.829-6.4 4.536-4.082c.297-.268.406-.686.278-1.065z"></path></svg>
                        ...
                        <button dir="rtl" class="my-2 font-bold text-md w-[95%] bg-slate-100 py-2 rounded-md">{{ $service->price }}</button>
        ...
        <div class="flex justify-center items-center">
            ...
            <a href="{{ route('service') }}" class="mx-auto text-center text-lg py-1 px-10 border border-blue-600 text-blue-600 hover:text-white hover:bg-blue-600 rounded-sm transition ease-in-out duration-500">أظهر المزيد</a>
