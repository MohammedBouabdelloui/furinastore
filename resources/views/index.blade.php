...
@section('content')
    ...
    <div class="mx-auto mb-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 xl:max-w-[1280px] font-cairo">
        
        <div class="flex justify-around items-center bg-white shadow-sm rounded-md p-4">
            <div dir="rtl">
                <h1 class="text-lg font-semibold">سرعة عالية</h1>
                <p class="text-sm">سرعة في الاداء بأعلى مستويات الكفاءة</p>
            </div>
        ...
        <div class="flex justify-around items-center bg-white shadow-sm rounded-md p-4">
            <div dir="rtl">
                <h1 class="text-lg font-semibold">الثقة و الضمان</h1>
                <p class="text-sm">الثقة والضمان قبل كل شيئ هي عنواننا</p>
            </div>
        ...
        <div class="flex justify-around items-center bg-white shadow-sm rounded-md p-4">
            <div dir="rtl">
                <h1 class="text-lg font-semibold">أرخص الأسعار</h1>
                <p class="text-sm">لن تجد أي متجر بنفس أثمنتنا الفريدة</p>
            </div>
        ...
        <div class="flex justify-around items-center bg-white shadow-sm rounded-md p-4">
            <div dir="rtl">
                <h1 class="text-lg font-semibold">أفضل الخدمات</h1>
                <p class="text-sm">نقدم خدمة بجودة عالية و سلاسة</p>
            </div>
    ...
    <div class="mx-auto xl:max-w-[1280px] font-cairo mt-12 my-4">
        ...
        <div class="flex justify-end items-center opacity-85 mb-8">
            <h1 dir="rtl" class="font-bold text-4xl mx-4">عروض شحن البرايموجيم و الوكلن مون</h1>
            <img src="{{ asset('img/icons/wish_icon_2.png') }}" alt="" class="w-16">
        </div>

        <div class="my-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-4 gap-y-12">
            
            <div class="bg-slate-50 rounded-md ">

                <div class="flex flex-col justify-center items-center">
                
                    <img src="{{ asset('img/posters/Furina-build.webp') }}" alt="" class="w-full h-[260px] object-cover rounded-xl">

                    <h1 class="font-bold text-lg my-2">وكلن مون</h1>

                    <div class="flex justify-center items-center mt-1">
                        <span class="mx-1 text-sm">(تم الشراء 127)</span>
                    ...
                    <button dir="rtl" class="my-2 font-bold text-lg w-[100%] bg-slate-200 py-2 rounded-md">48 د.م</button>
    ...
    <div class="mx-auto xl:max-w-[1280px] font-cairo mt-12 my-4">
        ...
        <div class="flex justify-end items-center opacity-85 mb-8">
            <h1 dir="rtl" class="font-bold text-4xl mx-4">حسابات الريرول المميزة بأفضل ثمن في السوق</h1>
            <img src="{{ asset('img/icons/wish_icon_2.png') }}" alt="" class="w-16">
        </div>
        ...
        <div class="my-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-4 gap-y-12">
            ...
            <div class="bg-slate-50 rounded-md ">
                ...
                <div class="flex flex-col justify-center items-center">
                    ...
                    <img src="{{ asset('img/posters/raiden-shogun.webp') }}" alt="" class="w-full h-[260px] object-cover rounded-xl">
