    ...
    <div class="my-4 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-2 gap-y-6 lg:gap-x-4 lg:gap-y-12 mx-2" dir="rtl">
        ...
        <div class="bg-slate-50 rounded-md ">
            ...
            <div class="flex flex-col justify-center items-center">
                ...
                <img src="{{ asset('storage/'. $advertisements->picture) }}" alt="" class="w-full h-[240px] lg:h-[260px] object-cover rounded-xl">

                <h1 class="font-bold text-lg my-2"> {{ $advertisements->title }}</h1>

                <div class="flex justify-center items-center mt-1">
                    <span class="mx-1 text-xs lg:text-sm">( {{ $advertisements->productOrder->count() }} تم الشراء )</span>
                ...
                <a href="{{ route('advertisements.details' , $advertisements->id) }}" dir="rtl" class="my-2 text-center  font-bold text-md w-[95%] bg-slate-200 py-2 rounded-md hover:bg-slate-300"> د.م {{ $advertisements->price }}</a>
