    ...
    <div class="my-4 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-2 gap-y-6 lg:gap-x-4 lg:gap-y-12 mx-2" dir="rtl">
        ...
        <div class="bg-slate-50 rounded-md ">
            ...
            <div class="flex flex-col justify-center items-center">
                ...
                <img src="{{ asset('storage/'. $advertisement->picture) }}" alt="" class="w-full h-[240px] lg:h-[260px] object-cover rounded-xl">

                <h1 class="font-bold text-lg my-2"> {{ $advertisement->title }}</h1>
