    ...
    <div dir="rtl" class="my-4 grid grid-cols-1 md:grid-cols-12 gap-x-2 gap-y-6 lg:gap-x-4 lg:gap-y-12 mx-2">
        ...
        <div class="bg-slate-50 rounded-md col-span-5">
            ...
            <div class="flex flex-col justify-center items-center">
                ...
                <img src="{{ asset('storage/' . $service->picture) }}" alt="" class="w-[400px] lg:w-[470px] h-[400px] lg:h-[470px] object-cover rounded-2xl">
        ...
        <div class="bg-slate-50 rounded-md col-span-7">
            ...
            <div class="flex flex-col justify-center items-start text-start">
                ...
                <h1 class="font-extrabold text-4xl my-6">{{ $service->title }}</h1>

                <div class="text-md text-gray-500 my-4">
                    {!! $service->description !!}
                </div>

                <h1 id="price" class="text-bold text-xl mt-3 mb-1"> {{ $service->price }} درهم</h1>

                <form action="{{ route('product.order.store') }}" method="post" class="font-cairo w-full">
                    ...
                    <input type="hidden" id="total_price" name="price" value="{{ $service->price }}">
                    
                    <input type="hidden" value="{{ $service->id }}" name="ordered_item_id">
                    <input type="hidden" value="App\Models\Service" name="ordered_table_type">
