...
Route::middleware(['admin'])->group(function(){
    ...
    Route::get('dashboard/topup/soft-delete' , [TopupController::class , 'showSoftDeleted'] )->name('dashboard/topup/soft_delete');
    Route::delete('dashboard/topup/soft-delete/{id}', [TopupController::class, 'softDelete'])->name('records/soft-delete');
